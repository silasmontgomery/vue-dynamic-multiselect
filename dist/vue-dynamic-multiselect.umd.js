    ...
    var script = {
        ...
        computed: {
            results: function() {
                ...
                return this.search ? this.options.filter(function (o) {
                    return String(o[this$1.optionText]).toLowerCase().indexOf(this$1.search.toLowerCase()) > -1 && !this$1.selectedOptions.find(function (s) { return s[this$1.optionValue]==o[this$1.optionValue]; });
                }) : this.options.filter(function (o) { return !this$1.selectedOptions.find(function (s) { return s[this$1.optionValue] == o[this$1.optionValue]; }); });
            },
